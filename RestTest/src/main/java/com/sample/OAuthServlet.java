...
@WebServlet(name = "oauth", urlPatterns = { "/oauth/*", "/oauth" }, initParams = {
		...
		@WebInitParam(name = "clientId", value = "3MVG9A2kN3Bn17hs13HR5LARUKQVLvN93x8lu_CmafwGbdgieAlbP8YqVhb.qmW2u4ZfAWLyQip6tfLYt98dY"),
		// clientSecret is 'Consumer Secret' in the Remote Access UI
		@WebInitParam(name = "clientSecret", value = "3201843554471620993"),
		// This must be identical to 'Callback URL' in the Remote Access UI
		@WebInitParam(name = "redirectUri", value = "https://localhost:8080/RestTest/oauth/_callback"),
	...
	protected void doGet(HttpServletRequest request,
		...
		if (accessToken == null) {
			...
			if (request.getRequestURI().endsWith("oauth")) {
				...
				HttpClient httpclient = DemoREST.prepareHttpClient();
